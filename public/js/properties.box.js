...
function putBox(data) {
    return $('<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">' +
        ...
        '</div>' +
        '<div class="figure" onclick="window.location = ' + "'/properties/show/422" + data.id + "'" + '">' +
        ...
        '</div>' +
        '<h2 onclick="window.location = ' + "'/properties/show/422" + data.id + "'" + '">' + data.title + '</h2>' +
        '<div class="cardAddress" onclick="window.location =' + "'/properties/show/" + data.id + "'" + '">' +
